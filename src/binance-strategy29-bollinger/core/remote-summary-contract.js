...
function validateUniverse(value) {
  ...
  if (absentFacts) {
    if ([value.generation, value.refreshed_at_ms, value.last_successful_refreshed_at_ms,
    ...
    if ((value.refresh_status === 'stale_if_error' || value.reason === 'selection_fail_closed')
      && value.last_refresh_error_at_ms === null) {
