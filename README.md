...
| 【自写】Binance 平仓数量倍率 | 自动读取最小量，支持手输或 +/- 调整倍数 | 本仓库 | [`点击安装`][install-binance-close-qty-preset] |
...
[install-binance-close-qty-preset]: https://raw.githubusercontent.com/jackhai9/userscripts/main/scripts/binance-close-qty-preset.user.js
