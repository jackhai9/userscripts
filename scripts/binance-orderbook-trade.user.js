...
(() => {
  ...
  (function() {
    ...
    async function openOrderbookPrecisionOptions(triggerElement) {
      ...
      if (getVisibleOrderbookPrecisionOptionNodes(triggerElement).length) return true;
      if (!triggerElement.matches?.(".tick-content") || !isVisibleElement(triggerElement) || isInsideOrderbookPriceRow(triggerElement)) return false;
      dispatchOrderbookPrecisionToggleSequence(triggerElement);
